            ...
            <MediaQuery minWidth={769}>
                <div className="items-center justify-center min-h-screen">
                    <div className="max-w-screen-lg mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 items-start p-6">
                        ...
                        <h1 className="font-karma text-3xl font-bold text-center text-4xl">styles by jao</h1>
        <h2 className="font-karma text-3xl font-semibold text-center text-xl">Mobile and UI/UX design</h2>
...
<div className="space-y-4">
<p className="text-lg leading-relaxed font-ubuntu">
  ...
  <p className="text-lg">
    ...
    <ul className="list-disc list-inside pl-4 font-ubuntu">
      ...
      <li>Moqups (Empathy Map)</li>
                        ...
                        <div className="md:col-span-4 space-y-6">
                            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
                                <h1 className="font-karma text-2xl font-bold">User Persona & Scenario</h1>
                                <hr className="border-t-2 border-black mt-2 mb-4" />
            ...
            <p className="font-ubuntu">Discovering the “styles,” app that promises to simplify his fashion choices, Matthew eagerly explores its features. He is thrilled to find personalized outfit recommendations based on his previous purchases and style preferences, saving him the hassle of mix-and-matching. With just a few taps, Matthew can now put together stylish outfits in minutes, freeing up his time to focus on his career and enjoy his newly found fashion sense.</p>
                        ...
                        <div className="md:col-span-4 space-y-6">
                            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
                                <h1 className="font-karma text-2xl font-bold">Empathy Map</h1>
                                <hr className="border-t-2 border-black mt-2 mb-4" />
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-beige-100 rounded-lg shadow-lg p-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
  <p className="text-base sm:text-lg leading-relaxed font-ubuntu">
    <span className="font-bold">Duration:</span> 14 hours
  </p>
  <p className="text-base sm:text-lg font-ubuntu">
    <span className="font-bold">Role:</span> UI/UX Designer
  </p>
  <p className="text-base sm:text-lg">
    <span className="font-bold">Tools:</span>
    <ul className="list-disc list-inside pl-4 font-ubuntu space-y-2">
      <li>Figma (user flow, wireframing, and prototype)</li>
      <li>Moqups (Empathy Map)</li>
    </ul>
  </p>
                        ...
                        <div className="md:col-span-4 space-y-6">
  <div className="bg-beige-100 rounded-lg shadow-lg p-6">
    <h1 className="font-karma text-xl sm:text-2xl font-bold">
    ...
    <div className="col-span-1">
        <p className="font-ubuntu  leading-relaxed mb-4">
        ...
        <p className="font-ubuntu  leading-relaxed">
      ...
      <div className="col-span-1 md:col-span-2">
        ...
        />
                        ...
                        <div  className="bg-beige-100 rounded-lg shadow-lg p-4">
                        <h1 className="font-karma text-xl font-bold">Empathy Map</h1>
                        <hr className="border-t-2 border-black mt-2 mb-4" />
