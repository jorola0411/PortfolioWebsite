    ...
    <>
      ...
      <div className="items-center justify-center min-h-screen">
        <div className="w-full bg-beige-200 py-10 mt-10 mb-10 shadow-lg">
          <h1 className="sm:text-xl md:text-4xl font-bold text-center" data-aos="fade-down"> styles by jao</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-8 mx-auto">
            ...
            <div className='col-span-1 sm:col-span-1 md:col-span-1'>
              ...
              <div className="relative flex justify-center items-center ">
                <img src={figma} alt="css3" className="mb-2 rounded-sm object-contain h-24" />
              </div>
            </div>
            ...
            <div className='col-span-1 sm:col-span-1 md:col-span-1'>
              ...
              <hr className="max-w-[25%] border-t-2 border-black mt-2 mb-4 mx-auto" />
              <p className="text-center">  Styles is a company that provides a mobile clothing shopping experience.
            ...
            <div className='col-span-1 sm:col-span-1 md:col-span-1'>
              ...
              <hr className="max-w-[25%] border-t-2 border-black mt-2 mb-4 mx-auto" />
              <p className='text-center'> 16 hours</p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-8 mx-auto max-w-[90%] mb-10">
          ...
          <div className='col-span-1 sm:col-span-1 md:col-span-1 bg-beige-100 shadow-lg p-3'>
            <h2 className='text-center md:text-2xl'>Empathy Map</h2>
            <hr className="border-t-2 border-black mt-2 mb-4" />

            <p className="sm:text-sm md:text-lg  mb-3">Empathy maps helps the designer see how the user feels or thinks when using the app. It helps the designer by focusing on the user needs. In this case, it highlights various concerns regarding if clothes match, app usability, and highlights of the app.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-8 mx-auto max-w-[90%] mb-10">
          ...
          <div className='col-span-1 sm:col-span-1 md:col-span-1 bg-beige-100 shadow-lg p-3'>
            <h2 className='text-center md:text-2xl'>Prototype</h2>
            <hr className="border-t-2 border-black mt-2 mb-4" />
            <p className="sm:text-sm md:text-lg  mb-3"> This is a prototype for the app, users can try on the virtual try on feature, as well as browse tops, and make a purchase.</p>
          </div>
        </div>
      </div>
