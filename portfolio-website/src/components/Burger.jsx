      ...
      <div className="items-center justify-center sm:px-4">
        <div className="max-w-screen-lg mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          <div className="md:col-span-4 space-y-2">
            ...
            <img src={burgerhero} alt="Burger Hero" description="Hero image for the Burger project, which showcases mockups of the project" className="w-96 mx-auto rounded"></img>
          </div>
          ...
          <div className="md:col-span-4 space-y-6" data-aos="flip-right" data-aos-anchor-placement="top-bottom">
            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
              ...
              <hr className="border-t-2 border-black mt-2 mb-4" />
              <ul className="list-disc list-inside pl-4 sm:text-sm md:text-base">
                <li>
          ...
          <div className="md:col-span-4 space-y-6" data-aos="flip-right" data-aos-anchor-placement="top-bottom">
            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
              ...
              <p className="sm:text-sm md:text-base py-2">
