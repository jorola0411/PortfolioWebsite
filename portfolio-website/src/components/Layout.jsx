    ...
    return (
        <>
            <div className='bg-offwhite dark:bg-caviar text-caviar dark:text-offwhite'>
                <nav className='flex md:text-lg md:px-32 pt-6 mb-20 justify-between'>
                    <Link to="/">
                ...
                <footer className='dark:bg-shadowgray bg-snow md:px-32 md:py-2'>
                    <div className="grid sm:grid-cols-2 md:grid-cols-2 mx-auto justify-between gap-20 items-end">
                        <div className='col-span-1 sm:text-left '>
                            <h5 className='text-xl mb-2'>Let's get in touch.</h5>
                            <p className="font-bold text-4xl md:text-left"><a href="mailto:jorola0411@gmail.com" className="hover:underline">jorola0411@gmail.com</a></p>
                        </div>

                        <div className='col-span-1 flex flex-col sm:text-left md:items-end  text-xl'>
                            <ul>
                        ...
                        <div className='col-span-1  flex  flex-col items-end'>
                            <p className='text-right'>Made with React.
                                <br />
