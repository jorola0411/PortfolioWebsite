          ...
          <div className=" mx-auto  ">
            ...
            <div className="sm:p-5 md:pl-5 lg:p-5 sm:col-span-4 md:col-span-2 flex flex-col justify-center sm:order-2 md:order-2 lg:order-2 xl:order-2" data-aos="fade-left">
                ...
                <div className='flex gap-5 sm:mb-5 md:mb-0'>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>JAVASCRIPT</p>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>REACT</p>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>API</p>
                </div>
              </div>
              ...
              <div className="sm:col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2 gap-4 sm:order-3 md:order-4 lg:order-4 xl:order-4" data-aos="fade-right">
                <Link to="lelem">
              ...
              <div className="sm:p-5 md:pr-5 lg:p-5 sm:col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2 flex flex-col justify-center  sm:order-4 md:order-3 lg:order-3 xl:order-3" data-aos="fade-right">
                ...
                <div className='flex gap-5 sm:mb-5 md:mb-0 sm:justify-start md:justify-end lg:justify-end'>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>JAVASCRIPT</p>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>HTML</p>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>CSS</p>
                </div>
              </div>
              ...
              <div className="sm:p-5 md:pl-5 lg:p-5 text-center sm:col-span-4 md:col-span-2 flex flex-col justify-center  sm:order-6 md:order-6 lg:order-6 xl:order-6 sm:text-left" data-aos="fade-left">
                ...
                <div className='flex justify-center gap-5 sm:mb-5 md:mb-0 sm:justify-start '>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>UI</p>
                  <p className='sm:text-sm md:text-sm lg:text-lg xl:text-3xl sm:p-1 md:p-1 lg:p-1 border border-black'>UX</p>
                </div>
              </div>
              ...
              <div className="sm:col-span-4 md:col-span-2 gap-4  sm:order-7 md:order-8 lg:order-8 xl:order-8" data-aos="fade-right">
                <Link to="monster">
              ...
              <div className="sm:p-5 md:pr-5 lg:p-5 sm:col-span-4 md:col-span-2 flex flex-col justify-center sm:order-8 md:order-7 lg:order-7 xl:order-7" data-aos="fade-right">
                <h1 className='sm:text-xl md:text-md lg:text-3xl xl:text-7xl sm:text-left md:text-right lg:text-right'>Monster Hunter API project</h1>
