        ...
        <>
            <section className="relative w-full bg-beige-100 lg:py-10 lg:mt-10 mb-10 p-10">
                ...
                <div className='flex gap-4 justify-center mb-3'>
                    ...
                    <button className="sm:text-sm md:text-lg lg:text-lg xl:text-3xl bg-beige-500 text-white px-6 py-2 hover:bg-orange-600 transition duration-200 gap-10 rounded-sm hover:scale-110 ease-in-out" data-aos="fade-right"> <a href="https://github.com/jorola0411/MonsterHunter-API-project.git" target="_blank">
                        GitHub
                    </a></button>

                    <button className="sm:text-sm md:text-lg lg:text-lg xl:text-3xl bg-beige-500 text-white px-6 py-2 hover:bg-orange-600 transition duration-200 rounded-sm hover:scale-110 ease-in-out" data-aos="fade-left"> <a href="http://mhapiproject.joseorola.ca/" target="_blank">
                        Live Website
                    </a></button>
