...
function Poster() {
    return (
        ...
        <h2 className="font-karma text-3xl font-semibold text-center text-xl">Graphic Design and Branding</h2>
            ...
            <img src="../src/assets/mockuphero.jpg" alt="hello" className="w-96 mx-auto"></img>
                        ...
                        <div className="md:col-span-4 space-y-6">
                            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
                                <h1 className="font-karma text-2xl font-bold">Original Ad</h1>
                                <hr className="border-t-2 border-black mt-2 mb-4" />
                                <p className="font-ubuntu text-gray-700">
                                ...
                                <div className="mt-4">
                                    <h2 className="font-karma text-lg font-bold">Redesign Goals:</h2>
                        ...
                        <div className="md:col-span-4">
                            <h1 className="font-karma text-2xl font-bold">Before and After</h1>
                            <hr className="border-t-2 border-black mt-2 mb-4" />
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="relative overflow-hidden rounded-lg shadow-md">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-25 flex items-center justify-center">
                                        <span className="text-white font-karma text-xl">Original</span>
                                    </div>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-black bg-opacity-25 flex items-center justify-center">
                                        <span className="text-white font-karma text-xl">Redesign</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-4 space-y-6">
                            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
                                <h1 className="font-karma text-2xl font-bold">Creative Process</h1>
                                <hr className="border-t-2 border-black mt-2 mb-4" />
                                <p className="font-ubuntu text-gray-700">
                        ...
                        <div className="md:col-span-4 space-y-6">
                            <div className="bg-beige-100 rounded-lg shadow-lg p-6">
                                <h1 className="font-karma text-2xl font-bold">Challenges and Solutions</h1>
                                <hr className="border-t-2 border-black mt-2 mb-4" />
                                <p className="font-ubuntu text-gray-700">
            ...
            <MediaQuery maxWidth={768}>
                <div className="p-4 space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <h2 className="font-karma text-lg font-semibold mt-1">Graphic Design and Branding</h2>
                        <hr className="border-t-2 border-black mt-2 mb-4" />
                        <img
                    ...
                    <div  className="bg-beige-100 rounded-lg shadow-lg p-4">
                        <h1 className="font-karma text-xl font-bold">Original Ad</h1>
                        <hr className="border-t-2 border-black mt-2 mb-4" />
                        <p className="font-ubuntu text-gray-700">
                    ...
                    <div>
                        <h1 className="font-karma text-xl font-bold text-center">Before and After</h1>
                        <hr className="border-t-2 border-black mt-2 mb-4" />
                        <div className="grid grid-cols-1 gap-4">
                            <div className="relative overflow-hidden rounded-lg shadow-md">
                                <img src="../src/assets/originalposter.jpg" alt="Original Poster" className="w-full"/>
                                <div className="absolute inset-0 bg-black bg-opacity-25 flex items-center justify-center">
                                    <span className="text-white font-karma text-lg">Original</span>
                                </div>
                            </div>
                            <div className="relative overflow-hidden rounded-lg shadow-md">
                                ...
                                />
                                <div className="absolute inset-0 bg-black bg-opacity-25 flex items-center justify-center">
                                    <span className="text-white font-karma text-lg">Redesign</span>
                                </div>
                            </div>

                            <div className="space-y-4">
        <div className="bg-beige-100 rounded-lg shadow-md p-4">
            <h1 className="font-karma text-xl font-bold">Creative Process</h1>
            <hr className="border-t-2 border-black mt-2 mb-4" />
            <p className="font-ubuntu text-gray-700">
                Every asset was created in Photoshop, and I chose to replicate the Snellen Chart using the Courier Std Bold, and added a blur effect to add perspective. I added the Snellen Chart to align with the message of eye exams, and added eyeglasses from Adobe Stock to frame the message as the focus of the poster. Finally, I added a blue gradient for color and to make the poster pop out more.
            </p>
    ...
    <div className="space-y-4">
        <div className="bg-beige-100 rounded-lg shadow-md p-4">
            <h1 className="font-karma text-xl font-bold">Challenges and Solutions</h1>
            <hr className="border-t-2 border-black mt-2 mb-4" />
            <p className="font-ubuntu text-gray-700">
